...
ttbl.config.targets['target'].thing_add('thing1', example_thing_plugger('p1'))
ttbl.config.targets['target'].thing_add('thing2', example_thing_plugger('p2'))
ttbl.config.targets['target'].thing_add('thing3', example_thing_plugger('p3'))
