...
drivers defined following :class:`tcfl.report_driver_c`, which can
...
class report_driver_c(tcfl.report_driver_c):
    def __init__(self, *args, **kwargs):
        import warnings
        fn = "tcfl.tc.report_driver_c"
        message = "replace with tcfl.report_driver_c"
        # FIXME: use a class decorator for this
        try:
            warnings.simplefilter('always', DeprecationWarning)
            warnings.warn(
                f"using deprecated {fn}: {message}",
                category = DeprecationWarning,
                stacklevel = 2
            )
        finally:
            warnings.simplefilter('default', DeprecationWarning)
        tcfl.report_driver_c.__init__(self, *args, **kwargs)


class target_c(tcfl.reporter_c):
    ...
    def __init__(self, rt, testcase, bsp_model, target_want_name,
        ...
        tcfl.reporter_c.__init__(self, testcase = testcase)
...
#
class tc_c(tcfl.reporter_c, metaclass=_tc_mc):
    r"""
    ...
    **alphabetical order** (not in declaration order!). The methods
    ...
    def __init__(self, name, tc_file_path, origin, hashid = None):
        ...
        tcfl.reporter_c.__init__(self, testcase = self)
