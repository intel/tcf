...
""",
    ...
    data_files = [
        ...
        ('@prefix@/share/tcf/ui/static/css',
            glob.glob('ui/static/css/*.css'),
        ),
        ('@prefix@/share/tcf/ui/static/css/external',
            glob.glob('ui/static/css/external/*.css'),
        ),
        ('@prefix@/share/tcf/ui/static/img',
            glob.glob('ui/static/img/*.*'),
        ),
        ('@prefix@/share/tcf/ui/static/js',
            glob.glob('ui/static/js/*.js'),
        ),
        ('@prefix@/share/tcf/ui/static/js/external',
            glob.glob('ui/static/js/external/*.js'),
        ),
